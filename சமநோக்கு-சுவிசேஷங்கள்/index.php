...
<head>
    ...
    <link rel="manifest" href="/good-news-collections/சமநோக்கு-சுவிசேஷங்கள்/manifest.json?v=<?php echo $version; ?>">
    <meta name="theme-color" content="#2196f3">
    <link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="css/font-awesome.min.css"/>
    <link rel="stylesheet" href="css/styles.css?v=<?php echo $version; ?>">
    <title>சமநோக்கு சுவிசேஷங்கள் - விரிவுரை - Synoptic Gospels Tamil Bible Commentary, published by Good News, hosted by Word of God Team, www.WordOfGod.in</title>
    <meta name="description" content="சமநோக்கு சுவிசேஷங்கள் - விரிவுரை - Synoptic Gospels Tamil Bible Commentary, published by Good News, hosted by Word of God Team, www.WordOfGod.in" />
...
<body>
        ...
        <nav class="navbar navbar-default navbar-static">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="http://wordofgod.in/good-news-collections/சமநோக்கு-சுவிசேஷங்கள்">சமநோக்கு சுவிசேஷங்கள்</a>
            </div>

            <!-- submenu elements for #b-menu-2 -->
            <div class="collapse navbar-collapse" id="b-menu-2">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="https://wordofgod.in/good-news-collections/சமநோக்கு-சுவிசேஷங்கள்"><span class="glyphicon glyphicon-home"></span> Home</a></li>
...
<center>
    ...
    <a href="html/head.php"><img src="assets/arrow-right.png"></a>
    <audio autoplay>
